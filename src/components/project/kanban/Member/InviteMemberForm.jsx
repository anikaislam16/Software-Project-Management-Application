                    ...
                    try {
                        ...
                        if (response.ok) {
                            if (data.message === "Member not found") {
                                ...
                                const response = await fetch(`http://localhost:3010/projects/kanban/member/member/${projectId}/${data._id}`, {
                                    method: 'POST',
                                    headers: {
                                        'Content-Type': 'application/json',
                                    },
                                ...
                                if (response.ok) {
                                    console.log('Member added successfully', data1.kanbanProject);
